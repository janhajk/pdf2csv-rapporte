      ...
      for (let name in documents) {
            ...
            keysLineNumbers.forEach(currentValue => {
                  lines.push({
                        ...
                        'GL/NA/ZL': documents[name][currentValue][0].text.trim(),
                        Planer: documents[name][currentValue][1].text.trim(),
                        Name: documents[name][currentValue][2].text.trim(),
                        Datum: documents[name][currentValue][3].text.trim(),
                        'Kat.': documents[name][currentValue][4].text.trim(),
                        'Tätigkeistbeschrieb': (documents[name][currentValue][5] && documents[name][currentValue][5].text.trim()) || '',
                        'Std.': (documents[name][currentValue][6] && documents[name][currentValue][6].text.trim()) || ''
                  });
            });
      }
      return lines;
