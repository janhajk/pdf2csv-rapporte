...
const groupContentByLines = function(documents) {
      ...
      // debuggin for counting all lines
      let lineCounter = 0;
      Object.keys(documentsLined).forEach(doc => {
            Object.keys(documentsLined[doc]).forEach(() => lineCounter++);
      });
      console.log('finished groupContentByLines(); total Lines: ' + lineCounter);
